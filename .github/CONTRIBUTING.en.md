...
2. Search the [existing issues](https://github.com/Misaka17032/Codex-Dream-Skin/issues) and [open pull requests](https://github.com/Misaka17032/Codex-Dream-Skin/pulls). If an active change already touches the same files, add to that discussion or split out a smaller change with no overlap.
