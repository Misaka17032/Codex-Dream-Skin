...
WINDOWS_ASSET_URL='https://github.com/Misaka17032/Codex-Dream-Skin/blob/main/windows/assets/'
...
for file in "$DOCS_TARGET"/*.md; do
  ...
  /usr/bin/sed \
    ...
    -e "s#https://github.com/Misaka17032/Codex-Dream-Skin/tree/main/windows/assets/#${WINDOWS_ASSET_TOKEN}#g" \
