...
[GitHub Releases](https://github.com/Misaka17032/Codex-Dream-Skin/releases) and
...
Open the repository's [new issue page](https://github.com/Misaka17032/Codex-Dream-Skin/issues/new/choose) and choose the bug form when reporting a problem. Include the Windows version, Codex source, reproduction steps, and relevant log lines. Remove secrets, `auth.json`, relay tokens, and private conversation content.
